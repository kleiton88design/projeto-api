			...
			<table>
				...
				<tbody>
					...
					<tr v-for="produto of produtos" :key="produto.id" >
						...
						<td>{{ produto.valor }}</td>
						<td>
							<button @click="editar(produto)" class="waves-effect btn-small blue darken-1">Editar</button>
							<button @click="remover(produto)" class="waves-effect btn-small red darken-1">Deletar</button>
						</td>
